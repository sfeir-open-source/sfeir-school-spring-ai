...
## Ollama 
Outil open-source qui exécute de grands modèles de langage (LLM) ou bien d'embedding directement sur une machine locale.
Utilisation des plusieurs modèles :
