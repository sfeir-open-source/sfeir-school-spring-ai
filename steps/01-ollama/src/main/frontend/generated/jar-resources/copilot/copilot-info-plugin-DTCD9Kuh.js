...
function M(e, t) {
  ...
  t || (t = {}), o = t.debug || !1;
  try {
    r = L(), n = document.createRange(), l = document.getSelection(), a = document.createElement("span"), a.textContent = e, a.ariaHidden = "true", a.style.all = "unset", a.style.position = "fixed", a.style.top = 0, a.style.clip = "rect(0, 0, 0, 0)", a.style.whiteSpace = "pre", a.style.webkitUserSelect = "text", a.style.MozUserSelect = "text", a.style.msUserSelect = "text", a.style.userSelect = "text", a.addEventListener("copy", function(i) {
    ...
    try {
      ...
      o && console.error("unable to copy using clipboardData: ", y), o && console.error("falling back to prompt"), s = J("message" in t ? t.message : O), window.prompt(s, e);
    }
  } finally {
...
var V = M;
const W = /* @__PURE__ */ D(V);
var _ = Object.defineProperty, z = Object.getOwnPropertyDescriptor, g = (e, t, o, s) => {
  for (var r = s > 1 ? void 0 : s ? z(t, o) : t, n = e.length - 1, l; n >= 0; n--)
    (l = e[n]) && (r = (s ? l(t, o, r) : l(r)) || r);
  return s && r && _(t, o, r), r;
};
let v = class extends N {
  constructor() {
    super(...arguments), this.serverInfo = [], this.clientInfo = [{ name: "Browser", version: navigator.userAgent }], this.handleServerInfoEvent = (e) => {
      ...
      this.serverInfo = t.versions, k().then((o) => {
  ...
  renderDevWorkflowSection() {
    ...
    return c`
      <dt>Java Hotswap</dt>
      <dd>${u(e === "success")} ${o}</dd>
      ${w() !== "unsupported" ? c`<dt>IDE Plugin</dt>
            <dd>${u(w() === "success")} ${t}</dd>` : S}
    `;
  }
...
let x = class extends H {
  ...
  render() {
    return c`<button title="Copy to clipboard" aria-label="Copy to clipboard" theme="icon tertiary">
      <span
        @click=${() => {
      U.emit("system-info-with-callback", {
        callback: W,
        notify: !0
      });
    }}
